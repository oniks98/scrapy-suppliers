...
Вигружає дані в: output/viatec_dealer.csv
...
class ViatecDealerSpider(ViatecBaseSpider, BaseDealerSpider):
    name = "viatec_dealer"
    supplier_id = "viatec"
    output_filename = "viatec_dealer.csv"
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Завантажуємо облікові дані з .env
        ...
        if not self.email or not self.password:
            raise ValueError("❌ Відсутні облікові дані VIATEC_EMAIL і VIATEC_PASSWORD в .env")
    ...
    def start_requests(self):
        """Спочатку GET /login → отримаємо cookies і csrf"""
    ...
    def parse_login_page(self, response):
        """Витягуємо CSRF токен та відправляємо форму логіну"""
    ...
    def after_login(self, response):
        """Перевірка успішної авторизації та старт парсингу"""
